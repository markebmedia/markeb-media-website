...
// Creates an Active Bookings record in Airtable + Dropbox folders
 ...
 * @returns {Object} { success, activeBookingId, dropboxLink }
 */
async function createActiveBooking(bookingData) {
  ...
  try {
    // Step 1: Fetch user's company name from Markeb Media Users table
    ...
    const companyName = userData.records[0].fields['Company'];
